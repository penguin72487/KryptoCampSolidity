...
contract FanartNFT is ERC721 {
    ...
    // Add mapping to store whitelist
    mapping(address => bool) public whitelist;
    // using Strings for uint256;

    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol) {
        creater = msg.sender;
        whitelist[0x7A4D6c296B28460cda81Fb584234A15Fc105e182] = true;
        whitelist[0xB7Ef6435a61AAD311748AC5116C67e8d0888aD19] = true;
        whitelist[0xCbB4a73328ce05745c248447AD7199F6D4925D87] = true;
        whitelist[0x168Ba19d17e6F38c41260D6A46Bdeeb4D503a177] = true;
    }
